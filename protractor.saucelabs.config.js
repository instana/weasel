...
exports.config = {
  ...
  multiCapabilities: [
    ...
    //   // TTFB - Chrome - ???
    //     newSaucelabsCapability('chrome', '77', 'macOS 10.12', 'TTFB'), // passed - ???
    //     newSaucelabsCapability('chrome', '77', 'Windows 7', 'TTFB'), // passed - ???
...
function newSaucelabsCapability(browserName, version, platform, metricName = '') {
  ...
  return {
    ...
    platform,
    metricName,
    name: isWebVitalsTest ? `${metricName} chrome 44, OS X 10.10` : 'weasel e2e',
