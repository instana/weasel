...
import { doc, nav, OriginalXMLHttpRequest } from '../browser';
...
const sendBeaconApiSupported = typeof nav.sendBeacon === 'function';
const isSupported = !!OriginalXMLHttpRequest && isVisibilityApiSupported && sendBeaconApiSupported;
